...
if($wcat=="Animals" || $wcat=="Random") {
  load_words("animals.txt","Animals",$wcat,$wc,$wordlist);
}
if($wcat=="Things" || $wcat=="Random") {
  load_words("things.txt","Things",$wcat,$wc,$wordlist);
}
if($wcat=="Colors" || $wcat=="Random") {
  load_words("colors.txt","Colors",$wcat,$wc,$wordlist);
}
if($wcat=="Verbs" || $wcat=="Random") {
  load_words("verbs.txt","Verbs",$wcat,$wc,$wordlist);
}

function load_words($fname,$catname,&$wcat,&$wc,&$wordlist) {
  //global $wordlist;
  //global $wcat,$wc;
...
if (isset($_POST["words"])) {
  $pwcnt = (int) $_POST["pwcnt"];
  $schar = (int) $_POST["schar"];
